...
# - - - - - - - - - - - - - - - - - - - - - - - - -
@bot.command(name="skip", description="Skips the current song in the VC queue.")
async def skip(interaction:discord.Interaction):
    if not interaction.guild.voice_client:
        await interaction.response.send_message(content="I am not in a voice channel.")
        return

    if not interaction.guild.voice_client.is_playing():
        await interaction.response.send_message(content="Nothing is playing at the moment.")
        return

    interaction.guild.voice_client.stop()
    await interaction.response.send_message(content="⏭ Skipping current song")
# - - - - - - - - - - - - - - - - - - - - - - - - -
